...
if __name__ == "__main__":
    ...
    if len(sys.argv) <= 10:
        ...
        print("Example (copy all): \n" + sys.argv[0] + " ALL https://sensorweb.us shake test sensorweb https://sensorweb.us testdb test sensorweb 2020-08-07T19:22:31.000 2020-08-07T19:22:35.000 America/New_York")
        ...
        print("Example (copy series Z only in localhost): \n" + sys.argv[0] + " Z https://localhost shake test sensorweb https://localhost testdb test sensorweb 2020-08-07T19:22:31.000 2020-08-07T19:22:35.000 America/New_York")
